...
class _MenuBodyState extends State<MenuBody> {
  final List<MenuItem> mostPopularItems = [
    ...
    // MenuItem(
    //name: 'Cheesecake',
    //image: 'assets\images\WhatsApp Image 2024-08-24 at 02.14.34_e7e6002b.jpg',
    // rating: getRandomRating(),
    // price: 699),
    MenuItem(
        name: 'Pasta Alfredo',
  ...
  final List<MenuCategory> menuCategories = [
    MenuCategory(
      ...
      items: [
        MenuItem(
            name: 'Spring Rolls',
            image: 'assets/images/springRolls.jpeg',
            rating: getRandomRating(),
            price: 399),
        MenuItem(
            name: 'Garlic Bread',
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Image.asset(widget.item.image,
                  width: 150, height: 70, fit: BoxFit.cover),
              Padding(
...
double getRandomRating() {
  final random = Random();
  return (random.nextDouble() * 5).clamp(3, 5).roundToDouble();
}